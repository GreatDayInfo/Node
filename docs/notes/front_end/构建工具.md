...
## [monorepo架构](https://juejin.cn/post/7184392660939964474)
...
> - 优势：
>   - 安装速度最快、节省磁盘空间
>     - pnpm 安装在集中位置缓存，借助软链接，依赖使用非扁平的包结构
>   
>   - 混合项目结构，monorepo项目通常包含多个app + 多个packages包
>   - 技术栈统一、项目间共享规范化、自动化、流程化
>   
>     - 多个项目中 标准化一套pretty、eslint、以及git hook等配置...
...
- 阶段2：具体monorepo架构
  ...
  - pnpm、turbo解决子包与主包关系
- 阶段3：自动化构建流程优化
  - 打包方案：**vite**、webpack、rollup、**tsup**、rolldown
